 ...
 * 必选参数
 */
$InitPHP_conf['url'] = 'http://sizz.initphp.com/';  
/**
 * 是否开启调试
 */
...
$InitPHP_conf['db']['default'][0]['host']                   = '172.16.0.3'; //主机
$InitPHP_conf['db']['default'][0]['username']               = 'cjsq'; //数据库用户名
$InitPHP_conf['db']['default'][0]['password']               = '1010'; //数据库密码
$InitPHP_conf['db']['default'][0]['database']               = 'cjsq_yx'; //数据库
...
$InitPHP_conf['controller'][' ']        = 'index'; //默认执行module
